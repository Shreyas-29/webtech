...
import { getGallery, getGalleryDetails, getSidePost, getSidePostDetails } from '../../services/graphql';
                            ...
                            <div className='flex flex-row space-x-2.5 items-center relative'>
                                ...
                                {modal && (
                                    <motion.div
                                        ...
                                        className='absolute transition-transform transform-gpu opacity-100 bg-white sm:-left-1/4 rounded-xl border p-4 sm:p-8 shadow-xl shadow-gray-500/30 origin-center backdrop-blur-lg'>
                                        <div className='h-max w-[17rem] sm:w-[30rem] flex items-center justify-center relative'>
                                            <div className='flex flex-col items-center justify-start w-full'>
                                                ...
                                                <form onSubmit={handleSubmit} className='w-full'>
                                                    <textarea required onChange={getInput} name="report" id="report" className='resize-none outline-none w-full p-4 rounded-md bg-gray-100' rows={4} placeholder='...' />
                                                    <div className='flex items-center justify-start w-full space-x-4 mt-4'>
                                                        <button type='submit' className='px-4 py-2 rounded-md bg-indigo-500 hover:bg-indigo-700 text-white font-medium text-sm'>
                                                            Send
                                                        </button>
...
export async function getStaticProps({ params }: any) {
    const data = await getSidePostDetails(params.slug);
